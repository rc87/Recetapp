...
//    }
	...
	public void start(Stage primaryStage) throws InterruptedException {
		...
		try {
			...
			loader.setLocation(MainPrueba.class.getResource("ui/Inicio.fxml"));
...
//			primaryStage.close();
		...
		recetAppStage.setOnCloseRequest(new EventHandler<WindowEvent>() {
...
//	}
	...
	public void initRootLayout() {
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MainPrueba.class.getResource("ui/Recetapp.fxml"));
			rootLayout = (AnchorPane) loader.load();
	...
	public void showAnadirReceta(RecetAppController recetAppController) {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MainPrueba.class.getResource("ui/Crear.fxml"));
	...
	public void showEditarReceta(RecetAppController recetAppController) {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MainPrueba.class.getResource("ui/Editar.fxml"));
			BorderPane page = (BorderPane) loader.load();
	...
	public void showAnadirIngrediente(SeccionesController seccionesController) {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MainPrueba.class
